...
import com.inscripts.cometchatpulse.demo.Presenters.GroupDeatailActivityPresenter;
...
public class GroupDetailActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new FontUtils(this);
        groupDetailPresenter = new GroupDeatailActivityPresenter();
...
//
        ...
        TextView tvSettingLabel = findViewById(R.id.settings);
        tvSettingLabel.setTypeface(FontUtils.robotoMedium);
    ...
    private void setViewPager() {
        ...
        adapter.addFragment(outcastMemberListFragment, getString(R.string.outcasted_member));
