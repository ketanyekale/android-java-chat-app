...
public class ContactListAdapter extends RecyclerView.Adapter<ContactListAdapter.ContactViewHolder> {
    ...
    private List<com.cometchat.cometchatpulse.models.User> userArrayList;
    ...
    public void onBindViewHolder(@NonNull ContactViewHolder contactViewHolder, final int i) {
        ...
        final com.cometchat.cometchatpulse.models.User user = userArrayList.get(i);
    ...
    public void refreshData(List<com.cometchat.cometchatpulse.models.User> userArrayList) {
